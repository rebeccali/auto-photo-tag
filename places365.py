...
# output: environment (string), category probabilities (float, array), categories (string, array), attributes (string)
class Place365(object):
    ...
    def __init__(self, imgpath, render_cam=False):
        # load the labels
        classes, labels_IO, labels_attribute, W_attribute = self.load_labels()
